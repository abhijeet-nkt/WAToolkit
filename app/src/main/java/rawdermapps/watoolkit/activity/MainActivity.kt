...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toggle = ActionBarDrawerToggle(
            this, drawer_layout, appbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close
        )
    ...
    private fun showStoragePermissionRequestDialog() {
        ...
        //User clicked 'deny' with 'do not ask again'
            ...
            AlertDialog.Builder(this)
                .setMessage("We need permission in order to save your status./n" +
